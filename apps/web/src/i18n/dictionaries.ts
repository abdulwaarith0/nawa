...
export type Namespace = "common" | "ai" | "auth" | "console";

type Dict = Record<string, unknown>;

export const DICTIONARIES: Record<TLocale, Record<Namespace, Dict>> = {
  en: { common: enCommon, ai: enAi, auth: enAuth, console: enConsole },
  ar: { common: arCommon, ai: arAi, auth: arAuth, console: arConsole },
};
