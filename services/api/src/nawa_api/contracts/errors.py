...
ERR_AI_TIMEOUT = ApiError(504, "The AI provider timed out")
ERR_AI_REFUSED = ApiError(502, "The AI provider declined to answer")
ERR_AI_TRUNCATED = ApiError(502, "The AI response was truncated")
ERR_AI_MALFORMED_OUTPUT = ApiError(502, "The AI returned malformed output")
